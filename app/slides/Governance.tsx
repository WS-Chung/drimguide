...
export default function Governance() {
  return (
    <SlideShell
      ...
      title="거버넌스 & 보안"
      description="공용 계정은 편하지만 위험할 수 있습니다. 다음 항목은 PMO가 분기별로 점검하고, 룰 변경은 자율 제안 → 합의 후 적용합니다."
    >
      <CardGrid cols={3}>
        ...
        <Card title="감사 로그" icon="◇" accent="emerald">
          Workspace · GitHub · Notion 감사로그 월 단위 보관, 이상 활동 알림
          자동화 검토.
        </Card>
        ...
        <Card title="변경 관리" icon="⇪" accent="brand">
          룰 변경 · 계정 재배분 · 한도 조정 등은{" "}
          <span className="font-mono text-brand-200">#ai-governance</span>에 제안 →
          분기 리뷰에서 합의 후 적용.
        </Card>
      </CardGrid>
