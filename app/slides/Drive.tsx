  ...
  return (
    ...
    >
      <div className="rounded-2xl glass p-4 sm:p-5">
        ...
        <pre className="overflow-x-auto rounded-lg bg-ink-950/85 border border-brand-500/20 p-3.5 text-[12px] leading-relaxed text-slate-200 font-mono whitespace-pre">{`AI-Knowhow/
├ skills/        # 검증된 작업 절차 (.md)
...
└ feedbacks/     # 막힌 케이스 · 개선 제안 · 실패 사례`}</pre>
      ...
      <CardGrid cols={2}>
        <Card title="🔌 Drive MCP 연결 — 도구별" badge="1회 셋업" accent="brand">
          ...
          <pre className="overflow-x-auto rounded-lg bg-ink-950/85 border border-brand-500/20 p-3 text-[11px] leading-relaxed text-slate-200 font-mono whitespace-pre mt-1">{`💬 내가 쓰는 AI 도구에 Google Drive
MCP를 연결하려면 어떻게 해야 해?
...
싶어.`}</pre>
        ...
        <Card title="📥 가져오기 — AI에게 부탁" accent="emerald">
          ...
          <pre className="overflow-x-auto rounded-lg bg-ink-950/85 border border-emerald-400/20 p-3 text-[11px] leading-relaxed text-slate-200 font-mono whitespace-pre mt-1.5">{`💬 AI-Knowhow/prompts 폴더의 .md 중
"코드 리뷰" 관련 파일을 가져와서
...
저장하고 보안 검사해줘.`}</pre>
        ...
        <Card title="📤 내보내기 — 내 결과를 공유" accent="emerald">
          ...
          <pre className="overflow-x-auto rounded-lg bg-ink-950/85 border border-emerald-400/20 p-3 text-[11px] leading-relaxed text-slate-200 font-mono whitespace-pre mt-1.5">{`💬 오늘 이 작업에서 잘 동작한 프롬프트를
...
출처는 함께 적어줘.`}</pre>
        ...
        <Card title="🛑 피드백 · 실패 케이스" accent="rose">
          ...
          <pre className="overflow-x-auto rounded-lg bg-ink-950/85 border border-rose-400/20 p-3 text-[11px] leading-relaxed text-slate-200 font-mono whitespace-pre mt-1.5">{`💬 방금 시도한 흐름이 막혔어. 무엇을
어떻게 했고 어디서 막혔는지 .md로
